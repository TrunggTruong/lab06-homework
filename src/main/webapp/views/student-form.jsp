...
<head>
    ...
    <title>
        <c:choose>
            <%-- MODIFICATION: Check if 'student' is present AND if 'isInsertError' is NOT true --%>
            <%-- Assuming you set request.setAttribute("isInsertError", true); in the Controller on validation failure for insert --%>
            <c:when test="${student != null && empty isInsertError}">
                Edit Student
            </c:when>
            <c:otherwise>
                Add New Student
    ...
    <div class="container">
        ...
        <form action="student" method="POST">
            <input type="hidden" name="action" 
                    value="${not empty isInsertError ? 'insert' : (student != null ? 'update' : 'insert')}">
            
            <c:if test="${student != null && empty isInsertError}">
            ...
            <div class="form-group">
                ...
                <input type="text" 
                        ...
                        <%-- MODIFICATION: Only apply 'readonly' if student exists AND we are NOT in an insert error state --%>
                        ${student != null && empty isInsertError ? 'readonly' : 'required'}
            ...
            <div class="button-group">
                <button type="submit" class="btn btn-primary">
                    <c:choose>
                        <%-- MODIFICATION: Use the 'isInsertError' check here too --%>
                        <c:when test="${student != null && empty isInsertError}">
                            💾 Update Student
                        </c:when>
                        <c:otherwise>
